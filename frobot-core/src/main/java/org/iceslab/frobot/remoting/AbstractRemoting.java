...
import org.iceslab.frobot.commons.support.ServiceThread;
import org.iceslab.frobot.commons.utils.general.RemotingHelper;
import org.iceslab.frobot.commons.utils.general.SemaphoreReleaseOnlyOnce;
import org.iceslab.frobot.commons.utils.general.SystemClock;
...
public abstract class AbstractRemoting implements Remoting {
     ...
     * @throws Exception
     */
    public void processMessageReceived(Channel channel,
     ...
     */
    @Override
    public RemotingCommand invokeSync(Channel channel,
     ...
     */
    @Override
    public void invokeAsync(Channel channel, final RemotingCommand request,
     ...
     */
    @Override
    public void invokeOneway(Channel channel, final RemotingCommand request,
                             long timeoutMillis)
            throws InterruptedException, RemotingTooMuchRequestException,
            RemotingTimeoutException, RemotingSendRequestException {
    ...
    class RemotingEventExecutor extends ServiceThread {
        private final LinkedBlockingQueue<RemotingEvent> eventQueue =
                new LinkedBlockingQueue<RemotingEvent>();
        ...
        @Override
        public void run() {
            LOGGER.info(this.getServiceName() + " 启动!");
