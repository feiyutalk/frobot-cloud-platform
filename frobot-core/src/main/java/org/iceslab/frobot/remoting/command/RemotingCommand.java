package org.iceslab.frobot.remoting.command;
...
public class RemotingCommand implements Serializable {
	...
	public static RemotingCommand createRequestCommand(RemotingProtos.RequestCode code, RemotingCommandBody body) {
		return createRequestCommand(code.code(), body);
	}
