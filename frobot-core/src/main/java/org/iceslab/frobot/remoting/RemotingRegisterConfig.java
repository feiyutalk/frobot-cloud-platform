...
public class RemotingRegisterConfig {
    /* Netty端口 */
    private int nettyPort = 8000;
    /* Socket端口*/
    private int socketPort = 8002;
    /* Selector线程数量*/
    private int registerSelectorThreads = Runtime.getRuntime().availableProcessors() * 2;
    /* 通信读事件未发生时，出现事件的时间*/
