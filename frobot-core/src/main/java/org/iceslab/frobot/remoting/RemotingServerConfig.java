...
public class RemotingServerConfig {
    ...
    /* 执行回调线程池线程数量 未使用*/
    private int serverCallbackExecutorThreads = AVAILABLE_PROCESSOR * 2;
    /* Selector线程数量*/
    private int serverSelectorThreads = AVAILABLE_PROCESSOR * 2;
    /* 单向请求的信号量 许可数目*/
    ...
    /* 请求后未获得响应的超时时间 */
    private int invokeTimeoutMillis = 1000_000_000;
